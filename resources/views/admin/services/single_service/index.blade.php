...
@section('content')
    ...
    <div class="row row-sm">
                                ...
                                @foreach ($services as $service)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{ $service->status == 1 ? trans('general.enabled') : trans('genearl.not_enabled') }}
                                        </td>
                                    ...
                                    @include('admin.services.single_service.edit')
                                    @include('admin.services.single_service.delete')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
        ...
        @include('admin.services.single_service.add')
        <!-- /row -->
