...
@section('title')
    {{ trans('Dashboard/departments.section') }}
@stop
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> <a
                        href="{{ route('sections.index') }}">{{ trans('Dashboard/departments.section') }}</a> </h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ $section->name }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
