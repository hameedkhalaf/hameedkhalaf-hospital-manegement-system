...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="side-item side-item-category">{{ trans('Dashboard/main-sidebar_trans.general') }}</li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{ trans('Dashboard/doctors.doctors') }}</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('doctors.index') }}">{{ trans('Dashboard/doctors.show_all') }}</a></li>
