...
class DoctorRepository implements DoctorRepositoryInterface
{
    ...
    public function index()
    {
        ...
        //return view('admin.doctors.table-data');
    ...
    public function create()
    {
        ...
        return view('admin.doctors.add',compact('sections','appointments'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.doctors.edit',compact('sections','appointments','doctor'));
    }
